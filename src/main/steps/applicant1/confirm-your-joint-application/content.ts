...
const en = ({ isDivorce, partner, userCase, isApplicant2, isJointApplication }: CommonContent) => ({
  ...
  financialOrderApplicant1: 'Applicant 1 is also applying to the court to make a financial order.',
  financialOrderApplicant2: 'Applicant 2 is also applying to the court to make a financial order.',
  ...
  countryOfCeremonyHeading: `Country of ${isDivorce ? 'marriage' : 'civil partnership'}`,
  countryOfCeremonyValue: userCase.ceremonyCountry,
...
const cy: typeof en = ({ isDivorce, partner, userCase, isApplicant2, isJointApplication }: CommonContent) => ({
  ...
  subHeader: `Dyma’r wybodaeth rydych chi a’ch ${partner} wedi’i darparu ar gyfer eich cais ar y cyd. Cadarnhewch yr wybodaeth cyn parhau.`,
  subHeading1: `${isDivorce ? 'Cais ar y cyd am ysgariad' : 'Cais ar y cyd i ddod â phartneriaeth sifil i ben'}`,
  ...
  line2: `Mae ${userCase.applicant1FirstNames} ${userCase.applicant1MiddleNames} ${userCase.applicant1LastNames} a ${
    userCase.applicant2FirstNames
  } ${userCase.applicant2MiddleNames} ${userCase.applicant2LastNames} yn gwneud cais i’r llys ${
    isDivorce ? 'am orchymyn ysgaru terfynol.' : 'i ddiddymu eu partneriaeth sifil.'
  } ${userCase.applicant1ApplyForFinancialOrder}`,
  financialOrderApplicant1: 'Mae Ceisydd 1 hefyd yn gwneud cais i’r llys i wneud gorchynyn ariannol.',
  financialOrderApplicant2: 'Mae Ceisydd 2 hefyd yn gwneud cais i’r llys i wneud gorchynyn ariannol.',
  ...
  line8: `Mae’r manylion hyn wedi’u copïo’n uniongyrchol oddi ar y dystysgrif ${
    isDivorce ? 'priodas' : 'partneriaeth sifil'
  },
     neu gyfieithiad o’r dystysgrif os nad yw’n Saesneg. Yr enwau ar y dystysgrif yw’r enwau roedd y ceiswyr yn eu defnyddio cyn y  ${
  ...
  line12: userCase.ceremonyPlace,
  countryOfCeremonyHeading: `Gwlad y ${isDivorce ? 'briodas' : 'bartneriaeth sifil'}`,
  countryOfCeremonyValue: userCase.ceremonyCountry,
  line13: `Dyddiad y ${isDivorce ? 'briodas' : 'bartneriaeth sifil'}`,
  line14: getFormattedDate(userCase.relationshipDate),
  subHeading3: 'Pam gall y llys ddelio â’r achos (awdurdodaeth)',
  line15: 'Mae gan llysoedd Cymru a Lloegr bŵer cyfreithiol (awdurdodaeth) i ddelio â’r achos hwn oherwydd:',
  connectionBulletPoints:
    userCase && userCase.connections
      ? enConnectionBulletPointsSummarisedForAllUsers(userCase.connections, isDivorce, isJointApplication)
      : [],
